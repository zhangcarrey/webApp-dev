<?php
	...
	// 全部
	$favoriteUrl = '../data/favorite.json';
	// 推荐
	...
	// 
	$favoriteResult = file_get_contents($favoriteUrl); //'{}'

	// $recResult = file_get_contents($recUrl); //'{}'

	// 转成数组
	$favoriteResult = json_decode($favoriteResult, true);
	// 转成数组
	...
	// 拼凑数据
	// $result = array('favorite'=>$favoriteResult, 'rec'=>$recResult);

	// 返回json数据
	echo json_encode($favoriteResult);
