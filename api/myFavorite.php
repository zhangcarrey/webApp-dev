<?php
	...
	// 全部
	$myFavoriteUrl = '../data/myFavorite.json';
	// 推荐
	...
	// 
	$myFavoriteResult = file_get_contents($myFavoriteUrl); //'{}'

	// $recResult = file_get_contents($recUrl); //'{}'

	// 转成数组
	$myFavoriteResult = json_decode($myFavoriteResult, true);
	// 转成数组
	// $recResult = json_decode($recResult, true);

	// var_dump($myFavoriteResult);

	// 拼凑数据
	// $result = array('myFavorite'=>$myFavoriteResult, 'rec'=>$recResult);

	// 返回json数据
	echo json_encode($myFavoriteResult);
